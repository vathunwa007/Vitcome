...
namespace netcore.Controllers
{
    public class CheckstatusController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            strSQL = "SELECT a.id,a.idstudent,a.username,a.lastname,a.email,a.idTeacher,a.status,b.id,b.Name,b.Skill,b.image FROM student a INNER JOIN teacher b ON a.idteacher = b.id WHERE a.id = '" + User.FindFirst("id").Value + "'";
            ...
            if (dtReader.HasRows == true) {
                ...
                ViewBag.teacherid= dtReader["idteacher"].ToString();
